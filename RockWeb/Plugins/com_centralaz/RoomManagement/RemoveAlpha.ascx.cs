...
namespace RockWeb.Plugins.com_centralaz.RoomManagement
{
    ...
    [Description( "Block to uninstall Room Management Alpha" )]
    public partial class RemoveAlpha : Rock.Web.UI.RockBlock
    {
        #region Fields
        ...
        protected void lUninstall_Click( object sender, EventArgs e )
        {
            var blockMigration = new BlockMigration();
            blockMigration.Up();
        }
        
    }

    public class BlockMigration : Migration
    {
        /// <summary>
        ...
        /// The SQL connection.
        /// </value>
        public override SqlConnection SqlConnection { get; set; }
        ...
        /// The SQL transaction.
        /// </value>
        public override SqlTransaction SqlTransaction { get; set; }
