...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <Rock:RockLiteral ID="lViewLinkedEvent" runat="server" Label="Linked Event" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:LinkButton ID="lbDeleteEventLinkage" runat="server" CausesValidation="false" CssClass="btn btn-danger btn-xs margin-b-md" OnClick="lbDeleteEventLinkage_Click"><i class="fa fa-times"></i> Remove Event Link</asp:LinkButton>
                                    <asp:LinkButton ID="lbCreateNewEventLinkage" runat="server" CausesValidation="false" CssClass="btn btn-primary btn-xs margin-b-md" Text="Link Reservation to Event" OnClick="lbCreateNewEventLinkage_Click" />
        ...
        <Rock:ModalDialog ID="dlgReservationEventOccurrence" runat="server" Title="Link Event to Reservation" SaveButtonText="Cancel" CancelLinkVisible="false" OnOkScript="clearActiveDialog();" ValidationGroup="ReservationEventOccurrence">
            <Content>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <Rock:RockCheckBoxList ID="cblCalendars" ValidationGroup="ReservationEvent" runat="server" Label="Calendars"
                                        ...
                                        OnSelectionChanged="cblCalendars_SelectionChanged" AutoPostBack="true" OnSelectedIndexChanged="cblCalendars_SelectionChanged"
                ...
                <asp:Panel ID="pnlEventOccurrence" runat="server" Visible="false">
                    ...
                    <fieldset>
                        ...
                        <div class="actions">
                            ...
                            <asp:LinkButton ID="lbNext_EventOccurrence" ValidationGroup="ReservationEventOccurrence" runat="server" AccessKey="n" Text="Finish" DataLoadingText="Finish" CssClass="btn btn-primary pull-right js-wizard-navigation" OnClick="lbNext_EventOccurrence_Click" />
                        </div>
                    </fieldset>
                </asp:Panel>
