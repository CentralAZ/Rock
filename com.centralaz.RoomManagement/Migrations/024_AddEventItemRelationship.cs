...
namespace com.centralaz.RoomManagement.Migrations
{
    ...
    public class AddEventItemRelationship : Migration
    {
        public override void Up()
        {
            ...
            // Attrib for BlockType: Reservation Detail:Enable Calendar Events
            RockMigrationHelper.UpdateBlockTypeAttribute( "C938B1DE-9AB3-46D9-AB28-57BFCA362AEB", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Enable Calendar Events", "EnableCalendarEvents", "", "If calendar events are not enabled, the Reservation Event Linkage button will be disabled.", 1, @"true", "0A6ED690-3C20-43A5-9CA7-C32A32483D29" );
            ...
            // Attrib Value for Block:Reservation Detail, Attribute:Enable Calendar Events Page: New Reservation, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "65091E04-77CE-411C-989F-EAD7D15778A0", "0A6ED690-3C20-43A5-9CA7-C32A32483D29", @"True" );
        }

        public override void Down()
        {
            RockMigrationHelper.DeleteAttribute( "0A6ED690-3C20-43A5-9CA7-C32A32483D29" );
